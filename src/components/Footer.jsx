...
//     <a href="https://nextdev.co.in" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 ml-2">
//                 Nextdev Labs
//               </a>
//   </span>
// </p>
    ...
    <div className="py-6 px-8 bg-[#130443] w-full">
      <div className="w-full max-w-screen-xl mx-auto relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-2 md:gap-6 w-full">
          <div className="flex flex-col">
            <div className="flex items-center gap-2 mb-4">
              <Link to="/">
                <img
                  src={assets.logo}
                  className="w-32 transform hover:scale-110 transition-transform duration-300 drop-shadow-lg hover:rotate-6"
                  alt="Company Logo"
                />
              </Link>
              <a
            ...
            {/* Empowering Text */}
            <p className="text-[#ffffff] text-sm leading-relaxed sm:text-left text-center sm:ml-7">
              Empowering businesses with cutting-edge solutions to streamline operations and accelerate growth.
            </p>

            {/* Social Links */}
            <div className="flex mt-3 space-x-4 sm:ml-7 justify-center sm:justify-start mx-auto sm:mx-0">
              {[ 
                "https://www.instagram.com/businessxstream.tbs/", 
                "https://www.facebook.com/profile.php?id=61572832430958&sk", 
                "https://www.youtube.com/@THORONDORBUSINESSSOLUTIONS" 
          ...
          <div className="mt-3 md:mt-7 md:ml-20">
            <p className="text-lg font-bold text-[#ffffff] mb-3">Quick Links</p>
            <ul className="space-y-2 text-sm text-[#ffffff]">
              {[ 
                { name: "Home", icon: <BiSolidHome className="text-orange-500 text-lg" /> }, 
